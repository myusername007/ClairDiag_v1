...
KNOWN_SYMPTOMS: list[str] = [
    ...
    "faiblesse bras", "asymétrie visage", "défense abdominale",
    "sueurs froides", "oppression thoracique", "hémoptysie",
...
SYNONYMS: dict[str, str] = {
    ...
    "tête qui explose":             "céphalée brutale",
    "tete explose":                 "céphalée brutale",
    "tête explose":                 "céphalée brutale",
    "ca dechire dans le dos":       "douleur dorsale",
    "ça déchire dans le dos":       "douleur dorsale",
    "dechire dos":                  "douleur dorsale",
    "déchire dos":                  "douleur dorsale",
    "ca me tire dans le bras":      "douleur bras",
    "ça me tire dans le bras":      "douleur bras",
    "tire dans le bras":            "douleur bras",
    "bouche bizarre":               "asymétrie visage",
    "bouche de travers":            "asymétrie visage",
    "visage bizarre":               "asymétrie visage",
    "bras ne répond plus":          "faiblesse bras",
    "bras qui bouge plus":          "faiblesse bras",
    "bras qui ne bouge plus":       "faiblesse bras",
    "bras gauche faible":           "faiblesse bras",
    "bras droit faible":            "faiblesse bras",
    "bras lourd":                   "faiblesse bras",
    "le bras ne répond":            "faiblesse bras",
    "bouche deviee":                "asymétrie visage",
    "bouche de travers":            "asymétrie visage",
    "visage penche":                "asymétrie visage",
    "sourire asymetrique":          "asymétrie visage",
    ...
    # défense abdominale / abdomen aigu
    "defense abdominale":           "défense abdominale",
    "ventre dur":                   "défense abdominale",
    "ventre rigide":                "défense abdominale",
    "fosse iliaque droite":         "douleur abdominale intense",
    "fosse iliaque gauche":         "douleur abdominale intense",
    "appendicite":                  "douleur abdominale intense",
    "douleur abdominale brutale":   "douleur abdominale intense",
    "douleur abdominale intense":   "douleur abdominale intense",
    "douleur brutale ventre":       "douleur abdominale intense",
    ...
    "ca serre dans la poitrine":    "oppression thoracique",
    "ca oppresse":                  "oppression thoracique",
    "sentiment oppression":         "oppression thoracique",
    "douleur poitrine":             "douleur thoracique",
    # allergie / anaphylaxie
    "allergie":                     "allergie",
    "allergique":                   "allergie",
    "reaction allergique":          "allergie",
    "choc allergique":              "allergie",
    "urticaire":                    "allergie",
    "plaques rouges":               "allergie",
    # raideur nuque / méningite
    "raideur nuque":                "raideur nuque",
    "nuque raide":                  "raideur nuque",
    "cou raide":                    "raideur nuque",
    "raideur du cou":               "raideur nuque",
    "raideur cou":                  "raideur nuque",
    # gorge serrée / qui ferme → anaphylaxie (avec et sans accents)
    "gorge serree":                 "gonflement gorge",
    "gorge serrée":                 "gonflement gorge",
    "gorge qui serre":              "gonflement gorge",
    "gorge qui ferme":              "gonflement gorge",
    "gorge bloquee":                "gonflement gorge",
    "gorge bloquée":                "gonflement gorge",
    "difficulte avaler":            "gonflement gorge",
    "difficulté avaler":            "gonflement gorge",
    "du mal a avaler":              "gonflement gorge",
    "mal à avaler":                 "gonflement gorge",
    ...
    # sueurs froides — marqueur ACS fort
    "sueurs froides":               "sueurs froides",
    "sueur froide":                 "sueurs froides",
    "sueurs":                       "sueurs froides",
    "en sueur":                     "sueurs froides",
    "je transpire froid":           "sueurs froides",
    ...
    # dyspnée effort
    "dyspnee effort":               "essoufflement",
    "dyspnee a l effort":           "essoufflement",
    "essoufflement a l effort":     "essoufflement",
    "manque d air":                 "essoufflement",
    "je manque d air":              "essoufflement",
    # épigastrique / sueurs ACS
    "douleur epigastrique":         "douleur abdominale",
    "douleur au creux de l estomac":"douleur abdominale",
    # confusion / méningite
    "confusion":                    "altération état général",
    "desorientation":               "altération état général",
    "etat confusionnel":            "altération état général",
    # urticaire / anaphylaxie
    "urticaire":                    "allergie",
    "plaques rouges":               "allergie",
    # crachats jaunes / purulents
    "crachats jaunes":              "expectorations",
    "crachats verts":               "expectorations",
    "crachats purulents":           "expectorations",
    # photophobie
    "photophobie":                  "photophobie",
    "sensible a la lumiere":        "photophobie",
    "lumiere insupportable":        "photophobie",
