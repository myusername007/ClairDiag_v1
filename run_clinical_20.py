...
CASES = [
    ...
    dict(id=6,  label="EMBOLIE",          syms=["essoufflement","douleur thoracique","palpitations"], onset="brutal",    duration="hours",  exp_top1="Embolie pulmonaire", exp_urg="élevé",  exp_tcs_max="fort", exp_emrg=False,ok_tests=allowed("Embolie pulmonaire","Angor","Pneumonie")),
    ...
    dict(id=9,  label="IC CLAIRE",        syms=["essoufflement","œdèmes","fatigue"],                 onset="progressif",duration="weeks",  exp_top1=None,        exp_urg="modéré", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("Insuffisance cardiaque","Asthme","Anémie","Angor")),
    dict(id=10, label="IC NOCTURNE",      syms=["essoufflement","fatigue","œdèmes"],                 onset=None,        duration=None,     exp_top1=None,        exp_urg="modéré", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("Insuffisance cardiaque","Asthme","Angor")),
    ...
    dict(id=13, label="RGO",              syms=["brûlure rétrosternale","reflux acide","après repas"],onset=None,        duration=None,     exp_top1="RGO",       exp_urg="faible", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("RGO","Gastrite")),
    ...
    dict(id=15, label="SII",              syms=["ballonnements","douleur chronique","fatigue"],        onset="progressif",duration="weeks",  exp_top1="SII",       exp_urg="faible", exp_tcs_max="besoin_tests",exp_emrg=False,ok_tests=allowed("SII","Gastrite")),
